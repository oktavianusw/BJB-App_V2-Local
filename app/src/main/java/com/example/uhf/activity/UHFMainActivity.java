...
import com.example.uhf.tools.Message_sender;
...
public class UHFMainActivity extends BaseTabFragmentActivity {
    ...
    private UHFMainActivity mainActivity;
    ...
    public void exportData() {
        ...
        if(Message_sender.messageSender(tagList)){
            Toast.makeText(this, "Data Send Successfully ", Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(this, "Data Send Failed ", Toast.LENGTH_LONG).show();
        }
